...
export default function KitchenManagerUpdateProduct({ navigation, route }) {
    ...
    const updateProduct = (item) => {
        navigation.navigate("KitchenManagerUpdateProductP2Screen", { item })
    }
                    ...
                    <View key={index}>
                        <View>
                            <View>
                                ...
                                ></Image>
                                <TouchableOpacity style={styles.price} onPress={() => updateProduct(item)}>
                                    <View>
