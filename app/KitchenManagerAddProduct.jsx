...
export default function KitchenManagerAddProduct({ navigation, props }) {
    ...
    const addProduct = async () => {
        if (checkDeitles()) {
            ...
            await fetch(`${ServerApi()}/api/uploadMenu`, {
                method: 'POST',
                ...
                .then((result) => {
                    ...
                    if (result.isOk) {
                        ...
                        Alert.alert("אופס", "קרתה טעות בעת העלאת המנה אנא נסה שוב ")
                    }               
                },
                    (error) => {
