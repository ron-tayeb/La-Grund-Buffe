...
export default function ManagerAddDeliveryPerson({ navigation, route }) {
    ...
    const addCustomer = async () => {
        ...
        await fetch(`${ServerApi()}/api/createDeliveryPerson`, {
            method: 'POST',
            ...
            .then((result) => {
                ...
                if (JSON.stringify(result) == 1) {
                    Alert.alert("כל הכבוד", "הרשמת שליח בוצעה בהצלחה")
                ...
                <TouchableOpacity onPress={() => { userVal() }}>
                    <View style={[styles.button, { marginTop: 30, }]} >
                        <LinearGradient
                            ...
                            <Text style={styles.textlogin}>          הוסף שליח          </Text>
                        </LinearGradient >
                    </View>
                </TouchableOpacity>
