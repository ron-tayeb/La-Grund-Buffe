...
export default function ManagerDelDeliveryPerson({ navigation, route }) {
    ...
    const deleteCustomer = async (item) => {//מחיקת משתמש
        let userID = item.DeliveryPersonCode
        await fetch(`${ServerApi()}/api/DelDeliveryPerson`, {
            method: 'POST',
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Image
                    source={require('../assets/logoS2/o.png')}
                    resizeMode='contain'
                    style={{
                        marginTop: 70,
                        width: '50%',
