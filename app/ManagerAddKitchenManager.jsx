...
export default function ManagerAddKitchenManager({ navigation, route }) {
    ...
    const addCustomer = async () => {
        ...
        await fetch(`${ServerApi()}/api/createKitchenManagers`, {
            method: 'POST',
            ...
            .then((result) => {
                ...
                if (JSON.stringify(result) == 1) {
                    Alert.alert("כל הכבוד", "הרשמת מנהל מטבח בוצעה בהצלחה")
    ...
    return (
        <View style={{ backgroundColor: "#FFF", height: '100%' }}>
            ...
            <View style={styles.header}>
                ...
                <Image
                    source={require('../assets/logoS2/j.png')}
                    resizeMode='contain'
                    style={{
                        marginTop: 50,
                        width: '55%',
                ...
                <TouchableOpacity onPress={() => { userVal() }}>
                    <View style={[styles.button, { marginTop: 30, }]} >
                        <LinearGradient
                            ...
                            <Text style={styles.textlogin}>          הוסף מנהל מטבח          </Text>
                        </LinearGradient >
                    </View>
                </TouchableOpacity>
