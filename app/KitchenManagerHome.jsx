...
export default function KitchenManagerHome({ navigation, route }) {
            ...
            <ImageBackground source={require('../assets/BG/two.png')} resizeMode="cover" style={{
                ...
                <View style={[styles.catgor]}>
                    <TouchableOpacity onPress={() => navigation.navigate("KitchenManagerOrderScreen")}>
                        <Image
                            source={require('../assets/logoB/a.png')}
                            resizeMode='contain'
                            style={{
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate("KitchenManagerAddProductScreen")}>
                        <Image
                            source={require('../assets/logoB/b.png')}
                            resizeMode="contain"
                            style={{
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate("KitchenManagerUpdateProductScreen")}>
                        <Image
                            source={require('../assets/logoB/d.png')}
                            resizeMode="contain"
                            style={{
                                width: 150,
                                height: 120,
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate("KitchenManagerDelProductScreen")}>
                        <Image
                            source={require('../assets/logoB/c.png')}
                            resizeMode='contain'
                            style={{
