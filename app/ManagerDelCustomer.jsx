...
export default function ManagerDelCustomer({ navigation, route }) {
    ...
    const deleteCustomer = async (item) => {//מחיקת משתמש
        let userID = item.CustomersCode
        await fetch(`${ServerApi()}/api/DelCustomers`, {
            method: 'POST',
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Image
                    source={require('../assets/logoS2/n.png')}
                    resizeMode='contain'
                    style={{
                        marginTop: 70,
                        width: '50%',
