        ...
        <View style={{ backgroundColor: "#FFF", height: '100%', }}>
            <ImageBackground source={require('../assets/BG/two.png')} resizeMode="cover" style={{
                ...
                <View style={[styles.header]}>
                    ...
                    <Image
                        source={require('../assets/logoS2/f.png')}
                        resizeMode='contain'
                        style={{
                            marginTop: 50,
                            width: '55%',
                ...
                <View style={[styles.catgor]}>
                    <TouchableOpacity onPress={() => navigation.navigate("ManagerAddCustomerScreen")}>
                        <Image
                            source={require('../assets/logoB/i.png')}
                            resizeMode='contain'
                            style={{
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate("ManagerAddDeliveryPersonScreen")}>
                        <Image
                            source={require('../assets/logoB/g.png')}
                            resizeMode="contain"
                            style={{
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate("ManagerAddKitchenManagerScreen")}>
                        <Image
                            source={require('../assets/logoB/e.png')}
                            resizeMode="contain"
                            style={{
                                width: 105,
                                height: 120,
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate("ManagerDelCustomerScreen")}>
                        <Image
                            source={require('../assets/logoB/j.png')}
                            resizeMode='contain'
                            style={{
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate("ManagerDelDeliveryPersonScreen")}>
                        <Image
                            source={require('../assets/logoB/k.png')}
                            resizeMode='contain'
                            style={{
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate("ManagerDelKitchenManagerScreen")}>
                        <Image
                            source={require('../assets/logoB/f.png')}
                            resizeMode='contain'
                            style={{
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate("ManagerUpdateCustomerScreen")}>
                        <Image
                            source={require('../assets/logoB/h.png')}
                            resizeMode="contain"
                            style={{
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate("ManagerUpdateDeliveryPersonScreen")}>
                        <Image
                            source={require('../assets/logoS2/b.png')}
                            resizeMode="contain"
                            style={{
                                width: 105,
                                height: 120,
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate("ManagerUpdateKitchenManagerScreen")}>
                        <Image
                            source={require('../assets/logoS2/a.png')}
                            resizeMode='contain'
                            style={{
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate("KitchenManagerOrderScreen")}>
                        <Image
                            source={require('../assets/logoB/m.png')}
                            resizeMode="contain"
                            style={{
                                width: 105,
                                height: 120,
